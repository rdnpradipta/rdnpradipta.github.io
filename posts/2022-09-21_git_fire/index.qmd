...
change the {uid} into something that is unique (such as your email)
after successful addition of command above, you can just run:
```bash
git fire
```
...
```
you can just run fire.bat in cmd.

At least this will do.
The most important thing in case of fire is **git out**!
